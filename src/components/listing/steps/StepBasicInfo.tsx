          ...
          {showProjectName && (
            <div>
              ...
              <input
                ...
                className="h-[46px] w-full rounded-[12px] border border-[#e5e7eb] bg-white px-3 text-[13px] outline-none placeholder:text-[#b6bcc5]"
              />
            </div>
          )}
        </div>
